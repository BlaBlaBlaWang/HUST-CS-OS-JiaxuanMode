...
struct direntstack{
	struct dirent* waitingdirent;
	struct direntstack* next dirent;
};

typedef struct direntstack direntstack;
//this struct is used for stack managment implementation of ls -lR
